...
(defn-
 crud-list?
 [xs]
 (every? (fn* [p1__395#] (some #{p1__395#} oprs)) (set xs)))
(entity
...
(defn-
 ...
 (let
  ...
  (str
   ...
   (s/join
    ","
    (map (fn* [p1__396#] (str "'" (str p1__396#) "'")) role-names))
   "))")))
(dataflow
...
(defn-
 ...
 (let
  ...
  (str
   ...
   (s/join
    ","
    (map (fn* [p1__397#] (str "'" (str p1__397#) "'")) names))
   "))")))
(dataflow
...
(def
 ...
 "c4f6ece8-c124-44a6-8521-4d1fc0300d4b")
